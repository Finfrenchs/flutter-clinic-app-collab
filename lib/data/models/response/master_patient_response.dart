...
class MasterPatientResponseModel {
    ...
    factory MasterPatientResponseModel.fromJson(String str) => MasterPatientResponseModel.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory MasterPatientResponseModel.fromMap(Map<String, dynamic> json) => MasterPatientResponseModel(
        data: json["data"] == null ? [] : List<MasterPatient>.from(json["data"]!.map((x) => MasterPatient.fromMap(x))),
...
class MasterPatient {
    ...
    factory MasterPatient.fromJson(String str) => MasterPatient.fromMap(json.decode(str));
